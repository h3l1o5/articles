...
![Skills 的類型](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/02-types-of-skills.jpg)
...
![製作 Skills 的技巧](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/03-tips-header.jpg)
...
![常見陷阱區段](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/04-gotchas.jpg)

任何 skill 中訊號密度最高的內容就是「常見陷阱」（Gotchas）區段。這些區段應該從 Claude 在使用你的 skill 時遇到的常見失敗點逐步累積而成。理想情況下，你會隨著時間持續更新你的 skill 來捕捉這些陷阱。

## 善用檔案系統與漸進式揭露

![檔案系統與漸進式揭露](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/05-file-system.jpg)
...
![避免過度限制 Claude](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/06-avoid-railroading.jpg)

Claude 通常會努力遵循你的指示，而因為 skills 具有高度的重複使用性，你要小心不要在指示中寫得過於具體。給 Claude 它需要的資訊，但同時保留讓它因地制宜的彈性。

## 仔細規劃初始設定

![仔細規劃初始設定](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/07-setup.jpg)
...
![description 欄位](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/08-description-field.jpg)
...
![記憶與資料儲存](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/09-memory.jpg)
...
![腳本與輔助函式](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/10-scripts-helpers.jpg)

接著 Claude 就能即時生成腳本來組合這些功能，針對「星期二發生了什麼事？」這類提問做更深入的分析。

![腳本組合](/articles/assets/img/posts/2026-03-18-lessons-from-building-claude-code-skills/11-scripts-compose.jpg)
